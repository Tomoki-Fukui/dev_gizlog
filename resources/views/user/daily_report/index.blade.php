...
<div class="main-wrap">
  <div class="btn-wrapper daily-report">
    {!! Form::open(['route' => 'report.index', 'method' => 'GET']) !!}
      {!! Form::input('month', 'search_month', !empty($inputs['search_month']) ? $inputs['search_month'] : null, ['class' => 'form-control']) !!}
      <button type="submit" class="btn btn-icon">
        <i class="fa fa-search"></i>
      </button>
    {!! Form::close() !!}
    <a class="btn btn-icon" href="{{ route('report.create') }}">
      ...
      <tbody>
        @foreach($daily_reports as $report)
          <tr class="row">
            ...
            <td class="col-xs-2">
              <a class="btn" href="report/{{ $report->id }}">
